...
export const gomokuStage = {
  size: 40,
  unit: '手',
  waitingSummary: (count) => `已完成 ${count} 手，当前仍未分出胜负。`,
  stoppedSummary: (count) => `已进行 ${count} 手，暂未分出胜负。对局由用户结束。`,
  stoppedState: (state) => ({ ...state, status: 'finished', completionReason: '用户选择结束对局' }),
};
...
<title>五子棋对局</title><style>
*{box-sizing:border-box}body{margin:0;background:#f6f7f8;color:#17191c;font-family:system-ui,sans-serif}.wrap{width:min(94vw,760px);margin:32px auto}header{display:flex;align-items:end;justify-content:space-between;margin-bottom:18px}h1{margin:0;font-size:22px}.meta{font-size:13px;color:#67717e}.board{display:grid;grid-template-columns:repeat(15,1fr);aspect-ratio:1;padding:3.333%;background:#d9a85d;border:1px solid #9c6b2d;box-shadow:0 12px 34px #1f29371f}.cell{position:relative}.cell::before,.cell::after{content:"";position:absolute;background:#805a2f66}.cell::before{left:0;right:0;top:50%;height:1px;transform:translateY(-.5px)}.cell::after{top:0;bottom:0;left:50%;width:1px;transform:translateX(-.5px)}.stone{position:absolute;z-index:1;left:50%;top:50%;width:88%;aspect-ratio:1;border-radius:50%;transform:translate(-50%,-50%);box-shadow:0 2px 4px #0005}.black{background:#17191c}.white{background:#f8fafc;border:1px solid #b8c0ca}.empty{display:none}@media(max-width:560px){.wrap{margin:16px auto}.stone{width:92%}}
